/* Меню v2, «Герой» v6 (20.09.2026): просмотр (чипы, портрет,
...
v6 (20.09.2026, требование владельца «убрать значок часов»): ячейки
НАДЕТЫХ слотов экипировки больше не печатают маркер 🕓 (картинки и имени
достаточно); пустые слоты сохраняют ➕. Инвентарь-список (screen_inventory.js)
иконок не содержал и не менялся. */
const Prog = {
  create: function () {
...
Router.register("hero", function (box) {
  ...
  SLOTS.forEach(function (s) {
    ...
    /* v6: без 🕓 у надетых; ➕ только у пустых слотов */
